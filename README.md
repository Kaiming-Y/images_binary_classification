...
1. Training
   ...
   You can choose a model from the [models implemented](https://github.com/abecedarian007/images_binary_classification/blob/master/README.md#models-implemented) following the argument `--model`.
