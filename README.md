...
1. Training
   ...
   You can choose a model from the [models implemented](https://github.com/abecedarian007/image_binary_classification/tree/master?tab=readme-ov-file#models-implemented) following the argument `--model`.
